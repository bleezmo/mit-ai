...
# family_rules.
same_identity = IF(OR('male (?y)','female (?y)'),THEN('same-identity (?y) (?y)'))
is_brother = IF(AND('male (?x)','parent (?y) (?x)','parent (?y) (?z)',\
  NOT('same-identity (?x) (?z)')),THEN('brother (?x) (?z)'))
is_sister = IF(AND('female (?x)','parent (?y) (?x)','parent (?y) (?z)',\
  NOT('same-identity (?x) (?z)')),THEN('sister (?x) (?z)'))
is_mother = IF(AND('female (?x)','parent (?x) (?y)'),\
  THEN('mother (?x) (?y)'))
is_father = IF(AND('male (?x)','parent (?x) (?y)'),\
  THEN('father (?x) (?y)'))
is_son = IF(AND('male (?x)','parent (?y) (?x)'),\
  THEN('son (?x) (?y)'))
is_daughter = IF(AND('female (?x)','parent (?y) (?x)'),\
  THEN('daughter (?x) (?y)'))
is_grandparent = IF(AND('parent (?y) (?x)','parent (?z) (?y)'),\
  THEN('grandparent (?z) (?x)','grandchild (?x) (?z)'))
is_cousin = IF(AND('parent (?x) (?j)','parent (?x) (?k)',\
  'parent (?j) (?y)', 'parent (?k) (?z)', NOT('same-identity (?j) (?k)')),\
  THEN('cousin (?y) (?z)'))

family_rules = [same_identity,is_brother,is_sister,is_mother,is_father,is_son,is_daughter,is_grandparent,is_cousin]                    # fill me in
